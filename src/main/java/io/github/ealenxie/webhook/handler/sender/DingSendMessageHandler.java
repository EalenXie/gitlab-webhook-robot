 ...
 * 钉钉机器人
 */
public class DingSendMessageHandler implements WebhookEventSendMessageHandler<String> {

    public final EventMessageGenerator eventMessageGenerator;


    public DingSendMessageHandler(EventMessageGenerator eventMessageGenerator) {
