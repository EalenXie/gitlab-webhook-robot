...
@Configuration
public class GitlabWebhookAutoConfig {
    ...
    @Bean
    @ConditionalOnMissingBean(name = "eventMessageGenerator")
    ...
    @Bean
    @ConditionalOnMissingBean
    public DingSendMessageHandler dingRobotSendMessageHandler(EventMessageGenerator eventMessageGenerator) {
        return new DingSendMessageHandler(eventMessageGenerator);
    }
}
